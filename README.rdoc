...
== Using YAML store instead of Redis

  require 'yaml/store'

  class RolloutManager
    attr_accessor :config_path, :store

    def initialize
      self.config_path = Rails.root.join('config', 'features.yml').to_s
      self.store = YAML::Store.new config_path
    end
  ...
  $rollout = Rollout.new(RolloutManager.new)

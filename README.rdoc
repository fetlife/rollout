...
If `nil` is passed in as a user, `active?` will always return false.

You can omit the second argument to easily check wether a feature is activated for all users.
